package org.jmolecules.example.axonframework.core.application.policy
...
class MoneyTransferProcessManager {
  ...
  fun on(evt: MoneyTransferRequestedEvent, moneyTransferCommandPort: MoneyTransferCommandPort) {
    ...
    try {
      ...
      moneyTransferCommandPort.cancelMoneyTransfer(moneyTransfer, Reason.reasonForMessage(e.message))
    }
  }
