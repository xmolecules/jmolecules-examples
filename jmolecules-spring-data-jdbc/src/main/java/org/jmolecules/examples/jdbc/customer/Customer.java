...
import org.jmolecules.examples.jdbc.customer.Customer.CustomerId;
 ...
 */
@Getter
@RequiredArgsConstructor(access = AccessLevel.PRIVATE, onConstructor = @__(@PersistenceCreator))
public class Customer implements AggregateRoot<Customer, CustomerId> {

	private final CustomerId id;
	private final @Embedded(onEmpty = OnEmpty.USE_NULL) Name name;
